...
CREATE TABLE IF NOT EXISTS `#__osdownloads_documents` (
  ...
  `twitter_hashtags` VARCHAR(50) NULL DEFAULT NULL,
  `twitter_via` VARCHAR(50) NULL DEFAULT NULL,
  `twitter_text` VARCHAR(140) NULL DEFAULT NULL,
  `mailchimp_list` VARCHAR(30) NULL DEFAULT NULL,
  `mailchimp_groups` VARCHAR(255) NULL DEFAULT NULL,
  `constantcontact_list` VARCHAR(30) NULL DEFAULT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB
