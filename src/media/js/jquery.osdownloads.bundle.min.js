...
return true;};var showPopup=function(selector){$(selector).reveal({animation:options.animation,animationspeed:200,closeonbackgroundclick:true,dismissmodalclass:'close-reveal-modal',});$('.osdownloads-custom-fields-container ul.nav li').first().find('a').trigger('click');};var goToDirectPage=function(){if(directPage){window.location=directPage;}};var addQueryVarToUri=function(url,variable,value){if(url.indexOf('?')>-1){url+='&';}else{url+='?';}
